    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            height: 100vh;
            margin: 0;
    background-image: url(" https://images.pexels.com/photos/6169157/pexels-photo-6169157.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1");
...
<body>
    ...
    <div id="main-content" class="main-content">
        <div class="container">
            <h2>Add Shipment</h2>
            <form action="AdminAddShipment" method="post">
