...
/**
 * Servlet implementation class UpdateShipmentStatus
 */
@WebServlet("/UpdateShipmentStatus")
public class UpdateShipmentStatus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            String sql = "UPDATE shipmentstatus SET status='" + status + "', place='" + place + "', estimateddays=" + estimatedDays + " WHERE id=" + id;
